...
import DashboardService from '../../Services/common-services/DashboardService'
                                    ...
                                    <div className="card card-primary bg-primary-gradient bubble-shadow">
                                        <div className="card-body">
                                            ...
                                            <ul className="list-unstyled">
                                                ...
                                                <li className="d-flex justify-content-between pb-1 pt-1"><small>/product/azzara/demo.html</small> <span>10</span></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div className="card-body">
                                            <div className="d-flex">
                                                ...
                                                <div className="flex-1 ml-3 pt-1">
                                                    <h5 className="text-uppercase fw-bold mb-1">Joko Subianto <span className="text-warning pl-3">pending</span></h5>
                                            ...
                                            <div className="d-flex">
                                                ...
                                                <div className="flex-1 ml-3 pt-1">
                                                    <h5 className="text-uppercase fw-bold mb-1">Prabowo Widodo <span className="text-success pl-3">open</span></h5>
                                            ...
                                            <div className="d-flex">
                                                ...
                                                <div className="flex-1 ml-3 pt-1">
                                                    <h5 className="text-uppercase fw-bold mb-1">Lee Chong Wei <span className="text-muted pl-3">closed</span></h5>
                                            ...
                                            <div className="d-flex">
                                                ...
                                                <div className="flex-1 ml-3 pt-1">
                                                    <h5 className="text-uppercase fw-bold mb-1">Peter Parker <span className="text-success pl-3">open</span></h5>
                                                    <span className="text-muted">I have some query regarding the license issue.</span>
                                                </div>
                                                <div className="float-right pt-1">
                                            ...
                                            <div className="d-flex">
                                                ...
                                                <div className="flex-1 ml-3 pt-1">
                                                    <h5 className="text-uppercase fw-bold mb-1">Logan Paul <span className="text-muted pl-3">closed</span></h5>
                                                    <span className="text-muted">Is there any update plan for RTL version near future?</span>
                                                </div>
                                                <div className="float-right pt-1">
                                                    <small className="text-muted">2 Days Ago</small>
