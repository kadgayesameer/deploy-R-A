  ...
  $(document).ready(function () {
    ...
    if (!r) {
      ...
      $("html").hasClass("sidebar_minimize") &&
        ((h = 1),
        f.addClass("toggled"),
        f.html('<small><i class="fa fa-ellipsis-v text-white"></i></small>')),
        f.on("click", function () {
          1 == h
            ? ($("html").removeClass("sidebar_minimize"),
              f.removeClass("toggled"),
              f.html('<small><i class="fa fa-bars text-white"></i></small>'),
              (h = 0))
            : ($("html").addClass("sidebar_minimize"),
              f.addClass("toggled"),
              f.html(
                '<small><i class="fa fa-ellipsis-v text-white"></i></small>'
              ),
              (h = 1)),
            $(window).resize();
        }),
